...
def create_question(question_text, days):
    ...
    :param question_text: description of the question
    :param days:
...
class QuestionResultsTests(TestCase):
    def test_results_view_with_a_future_question(self):
        """
        The voting results with a pub_date in the future should return a 404 not found.
    ...
    def test_results_view_with_a_old_question(self):
        """
        The voting results with a pub_date in the past should be displayed  on the page.
